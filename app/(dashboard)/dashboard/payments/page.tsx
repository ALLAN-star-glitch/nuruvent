...
export default function PaymentsPage() {
  ...
  const handleViewSelected = () => {
    if (selectedPayments.length === 1) {
      const payment = mockPayments.find(p => p.id === selectedPayments[0]);
      if (payment) {
        handleViewPayment(payment);
      }
    }
          ...
          <div className="px-6 pt-6 pb-8 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto mt-6 pb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-5">
                ...
                <div className="space-y-1.5 min-w-0 overflow-hidden">
                  <Label className="text-sm font-medium text-gray-700 truncate">Method</Label>
                  <Select value={selectedMethod} onValueChange={setSelectedMethod}>
                    <SelectTrigger className="h-11 cursor-pointer border-gray-200 rounded-xl focus:ring-primary/20 w-full">
                      <div className="truncate w-full text-left">
                        <SelectValue placeholder="All Methods" />
              ...
              <div className="space-y-1.5 mb-5">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="paymentDate" className="cursor-pointer">Date</SelectItem>
                  </SelectContent>
                </Select>
              </div>
